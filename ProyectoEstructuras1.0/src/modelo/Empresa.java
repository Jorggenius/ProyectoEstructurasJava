...
public class Empresa implements Serializable {
    ...
    private IList<Redencion> redenciones;
    ...
    public Empresa(String Nombre, int nit, AdmiFlota admiFlota) {
        ...
        this.redenciones = new Lista<>();
    }

    public IList<Redencion> getRedenciones() {
        return redenciones;
    }

    public void setRedenciones(IList<Redencion> redenciones) {
